...
<body>
    ...
    <div class="nav-bar">
       <div class="nav-logo">
          ...
          <h1>Citarasa<span> Hotel,</span><br>Harga<span> Warong</span></h1>
          <button onClick="document.location='homepakmat.html'" type="button" class="btn">USER</button>
          <button onClick="document.location='adminlogin.php'" type="button" class="btn">ADMIN</button>
