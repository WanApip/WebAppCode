...
<body>
    ...
    <div class="nav-bar">
       <div class="nav-logo">
         ...
         <form action="adminrecordfoundcustomer.php" method="post">

            <h1 style="color:white" align="center">Search Record Customer </h1>
            <p style="color:white" align="center" ><label class="label" for="customer_id">ID Number : </label>
               <input id="customer_id" type="text" name="customer_id" size="30" maxlength="30"
               value="<?php if (isset($_POST['customer_id'])) echo $_POST['customer_id']; ?>"/></p><br>
